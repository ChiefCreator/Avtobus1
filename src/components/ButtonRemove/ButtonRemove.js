...
export default class ButtonRemove extends DefaultComponent {
  ...
  _create() {
    const innerHTML = `
      <svg class="button-remove__icon" xmlns="http://www.w3.org/2000/svg" width="16" height="20" viewBox="0 0 16 20" fill="none">
    ...
    return createDOM("button", { className: `button-remove ${this.className}`, innerHTML });
  }
}